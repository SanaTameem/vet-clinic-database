...
SELECT COUNT(*) FROM visits LEFT JOIN specializations ON visits.animal_id = specializations.species_id AND visits.vet_id = specializations.vet_id WHERE specializations.species_id IS NULL;
