...
- [Live Demo Link of the diagram](https://drawsql.app/teams/sana-tameem/diagrams/vet-clinic-diagram)
...
Clone this repository to your desired folder:
  ...
  cd my-folder
  git clone https://github.com/SanaTameem/vet-clinic-database.git
...
Feel free to check the [issues page](https://github.com/SanaTameem/vet-clinic-database/issues).
...
This project is [MIT](https://github.com/SanaTameem/vet-clinic-database/blob/feature/update-animal/MIT.md) licensed.
